 ...
 * A subclass of MotorizedVehicle that consist of methods used in car carrier truck.
 * Also implements the interface ITransportableHolder and uses parametric type T which extends interface ITransportable.
 */
public class CarCarrierTruck<T extends ITransportable> extends MotorizedVehicle implements ITransportableHolder<T>{
    ...
    /**
     * Unloads a transportable off the truck
     */
    @Override
